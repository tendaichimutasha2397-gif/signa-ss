...
const KNOWN_ASSETS = [
  ...
  { symbol: 'ADA', names: ['cardano'] },
  { symbol: 'AVAX', names: ['avalanche'] },
  { symbol: 'LINK', names: ['chainlink'] },
  { symbol: 'MATIC', names: ['polygon'] },
  { symbol: 'LTC', names: ['litecoin'] },
  { symbol: 'DOT', names: ['polkadot'] },
  { symbol: 'BNB', names: ['binance coin', 'bnb'] },
  { symbol: 'NFLX', names: ['netflix'] },
  { symbol: 'AMD', names: ['advanced micro devices', ' amd '] },
  { symbol: 'INTC', names: ['intel'] },
  { symbol: 'JPM', names: ['jpmorgan', 'jp morgan'] },
  { symbol: 'BAC', names: ['bank of america'] },
  { symbol: 'DIS', names: ['disney'] },
  { symbol: 'COIN', names: ['coinbase'] },
  { symbol: 'PLTR', names: ['palantir'] },
];
...
function scoreItem(item, watchlist) {
  ...
  return { ...item, figures, assets, moverScore: mover, spotlight, priority, sentiment };
}
