...
function computeIndicators(closes, volumes = []) {
  ...
  const confluence = computeConfluence({ trend, latestRsi, latestHist, volumeSpike });
 ...
 */
function computeConfluence({ trend, latestRsi, latestHist, volumeSpike }) {
  const readings = [];
...
module.exports = { sma, ema, rsi, macd, computeIndicators, computeConfluence, rsiZone };
